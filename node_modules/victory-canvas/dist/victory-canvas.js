...
var getBarWidth = function (barWidth, props) {
  ...
  if (barWidth) {
    return victory_core__WEBPACK_IMPORTED_MODULE_2__.evaluateProp(barWidth, props);
  } else if (style.width) {
    return style.width;
  }
...
var getCornerRadiusFromObject = function (cornerRadius, props) {
  ...
  var updateCornerRadius = function (corner, fallback) {
    if (!lodash_isNil__WEBPACK_IMPORTED_MODULE_1___default()(cornerRadius[corner])) {
      realCornerRadius[corner] = victory_core__WEBPACK_IMPORTED_MODULE_2__.evaluateProp(cornerRadius[corner], props);
    } else if (!lodash_isNil__WEBPACK_IMPORTED_MODULE_1___default()(cornerRadius[fallback])) {
      realCornerRadius[corner] = victory_core__WEBPACK_IMPORTED_MODULE_2__.evaluateProp(cornerRadius[fallback], props);
    }
  };
...
var getCornerRadius = function (cornerRadius, props) {
  ...
  realCornerRadius.topLeft = victory_core__WEBPACK_IMPORTED_MODULE_2__.evaluateProp(cornerRadius, props);
  realCornerRadius.topRight = victory_core__WEBPACK_IMPORTED_MODULE_2__.evaluateProp(cornerRadius, props);
  return realCornerRadius;
};
var getStyle = function () {
  ...
  return victory_core__WEBPACK_IMPORTED_MODULE_2__.evaluateStyle(Object.assign(baseStyle, style), props);
};
