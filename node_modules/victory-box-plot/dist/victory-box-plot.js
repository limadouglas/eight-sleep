...
/* harmony import */ var lodash_isNaN__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! lodash/isNaN */ "../../../node_modules/.pnpm/lodash@4.17.21/node_modules/lodash/isNaN.js");
...
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-util/scale.js");
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-util/collection.js");
/* harmony import */ var victory_vendor_d3_array__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! victory-vendor/d3-array */ "../../victory-vendor/es/d3-array.js");
...
var getSummaryStatistics = function (data) {
  ...
  var quartiles = {
    _q1: nanToNull((0,victory_vendor_d3_array__WEBPACK_IMPORTED_MODULE_7__.quantile)(dependentVars, 0.25)),
    // eslint-disable-line no-magic-numbers
    _q3: nanToNull((0,victory_vendor_d3_array__WEBPACK_IMPORTED_MODULE_7__.quantile)(dependentVars, 0.75)),
    // eslint-disable-line no-magic-numbers
    _min: nanToNull((0,victory_vendor_d3_array__WEBPACK_IMPORTED_MODULE_7__.min)(dependentVars)),
    _median: nanToNull((0,victory_vendor_d3_array__WEBPACK_IMPORTED_MODULE_7__.quantile)(dependentVars, 0.5)),
    _max: nanToNull((0,victory_vendor_d3_array__WEBPACK_IMPORTED_MODULE_7__.max)(dependentVars))
  };
  ...
  if (!isProcessed) {
    ...
    if (arrayX) {
      ...
      return data.map(function (datum) {
        ...
        var sortedData = lodash_orderBy__WEBPACK_IMPORTED_MODULE_6___default()(dataArray, sortKey);
      ...
      return lodash_keys__WEBPACK_IMPORTED_MODULE_2___default()(groupedData).map(function (key) {
        ...
        var sortedData = lodash_orderBy__WEBPACK_IMPORTED_MODULE_6___default()(datum, sortKey);
...
var getData = function (props) {
  ...
  var formattedData = victory_core__WEBPACK_IMPORTED_MODULE_8__.formatData(props.data, props, accessorTypes);
  return formattedData.length ? processData(formattedData) : [];
};

var reduceDataset = function (dataset, props, axis) {
  var minDomain = victory_core__WEBPACK_IMPORTED_MODULE_9__.getMinFromProps(props, axis);
  var maxDomain = victory_core__WEBPACK_IMPORTED_MODULE_9__.getMaxFromProps(props, axis);
  ...
  return victory_core__WEBPACK_IMPORTED_MODULE_9__.getDomainFromMinMax(minData, maxData);
};
...
var getDomainFromData = function (props, axis) {
  ...
  if (dataset.length < 1) {
    return minDomain !== undefined && maxDomain !== undefined ? victory_core__WEBPACK_IMPORTED_MODULE_9__.getDomainFromMinMax(minDomain, maxDomain) : undefined;
  }
...
var getDomain = function (props, axis) {
  return victory_core__WEBPACK_IMPORTED_MODULE_9__.createDomainFunction(getDomainFromData)(props, axis);
};
...
var getLabelStyle = function (props, styleObject, namespace) {
  ...
  if (!victory_core__WEBPACK_IMPORTED_MODULE_10__.isTooltip(component)) {
    return baseStyle;
  }

  var tooltipTheme = props.theme && props.theme.tooltip || {};
  return lodash_defaults__WEBPACK_IMPORTED_MODULE_5___default()({}, tooltipTheme.style, baseStyle);
};
...
var getStyles = function (props) {
  ...
  var labelStyles = lodash_defaults__WEBPACK_IMPORTED_MODULE_5___default()({}, style.labels, getLabelStyle(props, styleObject));

  var boxStyles = lodash_defaults__WEBPACK_IMPORTED_MODULE_5___default()({}, style.boxes, styleObject.boxes);

  var whiskerStyles = lodash_defaults__WEBPACK_IMPORTED_MODULE_5___default()({}, style.whiskers, styleObject.whiskers);

  return {
    boxes: boxStyles,
    labels: labelStyles,
    parent: lodash_defaults__WEBPACK_IMPORTED_MODULE_5___default()({}, style.parent, styleObject.parent, parentStyles),
    max: lodash_defaults__WEBPACK_IMPORTED_MODULE_5___default()({}, style.max, styleObject.max, whiskerStyles),
    maxLabels: lodash_defaults__WEBPACK_IMPORTED_MODULE_5___default()({}, style.maxLabels, getLabelStyle(props, styleObject, "max"), labelStyles),
    median: lodash_defaults__WEBPACK_IMPORTED_MODULE_5___default()({}, style.median, styleObject.median, whiskerStyles),
    medianLabels: lodash_defaults__WEBPACK_IMPORTED_MODULE_5___default()({}, style.medianLabels, getLabelStyle(props, styleObject, "median"), labelStyles),
    min: lodash_defaults__WEBPACK_IMPORTED_MODULE_5___default()({}, style.min, styleObject.min, whiskerStyles),
    minLabels: lodash_defaults__WEBPACK_IMPORTED_MODULE_5___default()({}, style.minLabels, getLabelStyle(props, styleObject, "min"), labelStyles),
    q1: lodash_defaults__WEBPACK_IMPORTED_MODULE_5___default()({}, style.q1, styleObject.q1, boxStyles),
    q1Labels: lodash_defaults__WEBPACK_IMPORTED_MODULE_5___default()({}, style.q1Labels, getLabelStyle(props, styleObject, "q1"), labelStyles),
    q3: lodash_defaults__WEBPACK_IMPORTED_MODULE_5___default()({}, style.q3, styleObject.q3, boxStyles),
    q3Labels: lodash_defaults__WEBPACK_IMPORTED_MODULE_5___default()({}, style.q3Labels, getLabelStyle(props, styleObject, "q3"), labelStyles),
...
var getCalculatedValues = function (props) {
  ...
  var range = {
    x: victory_core__WEBPACK_IMPORTED_MODULE_10__.getRange(props, "x"),
    y: victory_core__WEBPACK_IMPORTED_MODULE_10__.getRange(props, "y")
  };
  var domain = {
    x: getDomain(props, "x"),
    y: getDomain(props, "y")
  ...
  var scale = {
    x: victory_core__WEBPACK_IMPORTED_MODULE_11__.getBaseScale(props, "x").domain(domain.x).range(props.horizontal ? range.y : range.x),
    y: victory_core__WEBPACK_IMPORTED_MODULE_11__.getBaseScale(props, "y").domain(domain.y).range(props.horizontal ? range.x : range.y)
  };
...
var getLabelProps = function (props, text, type) {
  ...
  return lodash_defaults__WEBPACK_IMPORTED_MODULE_5___default()({}, labelProps, victory_core__WEBPACK_IMPORTED_MODULE_10__.omit(tooltipTheme, ["style"]));
};
...
var isDatumOutOfBounds = function (datum, domain) {
  ...
  var _x = datum._x,
      _min = datum._min,
      _max = datum._max;
  var minDomainX = victory_core__WEBPACK_IMPORTED_MODULE_12__.getMinValue(domain.x);
  var maxDomainX = victory_core__WEBPACK_IMPORTED_MODULE_12__.getMaxValue(domain.x);
  var minDomainY = victory_core__WEBPACK_IMPORTED_MODULE_12__.getMinValue(domain.y);
  var maxDomainY = victory_core__WEBPACK_IMPORTED_MODULE_12__.getMaxValue(domain.y);
...
var getBaseProps = function (initialProps, fallbackProps) {
  var modifiedProps = victory_core__WEBPACK_IMPORTED_MODULE_10__.modifyProps(initialProps, fallbackProps, "boxplot");
...
/* harmony import */ var lodash_isNil__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lodash/isNil */ "../../../node_modules/.pnpm/lodash@4.17.21/node_modules/lodash/isNil.js");
/* harmony import */ var lodash_isNil__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lodash_isNil__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var lodash_flatten__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! lodash/flatten */ "../../../node_modules/.pnpm/lodash@4.17.21/node_modules/lodash/flatten.js");
...
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-primitives/border.js");
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-primitives/whisker.js");
...
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-primitives/line-segment.js");
      ...
      var labelComponents = lodash_flatten__WEBPACK_IMPORTED_MODULE_1___default()(types.map(function (type) {
        var components = _this.dataKeys.reduce(function (validComponents, _key, index) {
          ...
          if (labelProps.text !== undefined && labelProps.text !== null) {
            validComponents.push( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().cloneElement(baseComponent, labelProps));
          }
...
VictoryBoxPlotBase.defaultTransitions = victory_core__WEBPACK_IMPORTED_MODULE_5__.discreteTransitions();
VictoryBoxPlotBase.defaultProps = {
  containerComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_6__.VictoryContainer, null),
  data: defaultData,
  dataComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_7__.Border, null),
  groupComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement("g", {
    role: "presentation"
  }),
  maxComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_8__.Whisker, null),
  maxLabelComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_9__.VictoryLabel, null),
  medianComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_10__.LineSegment, null),
  medianLabelComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_9__.VictoryLabel, null),
  minComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_8__.Whisker, null),
  minLabelComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_9__.VictoryLabel, null),
  q1Component: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_7__.Border, null),
  q1LabelComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_9__.VictoryLabel, null),
  q3Component: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_7__.Border, null),
  q3LabelComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_9__.VictoryLabel, null),
  samples: 50,
  sortKey: "x",
  sortOrder: "ascending",
  standalone: true,
...
VictoryBoxPlotBase.getDomain = _helper_methods__WEBPACK_IMPORTED_MODULE_12__.getDomain;
VictoryBoxPlotBase.getData = _helper_methods__WEBPACK_IMPORTED_MODULE_12__.getData;
...
var VictoryBoxPlot = (0,victory_core__WEBPACK_IMPORTED_MODULE_13__.addEvents)(VictoryBoxPlotBase, options);
...
var isNumber = __webpack_require__(/*! ./isNumber */ "../../../node_modules/.pnpm/lodash@4.17.21/node_modules/lodash/isNumber.js");
...
VictoryAnimation.contextType = _victory_util_timer_context__WEBPACK_IMPORTED_MODULE_4__["default"];
...
/* harmony import */ var _victory_portal_portal__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../victory-portal/portal */ "../../victory-core/es/victory-portal/portal.js");
...
/* harmony import */ var _victory_util_timer_context__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../victory-util/timer-context */ "../../victory-core/es/victory-util/timer-context.js");
...
VictoryContainer.defaultProps = {
  ...
  portalComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_victory_portal_portal__WEBPACK_IMPORTED_MODULE_8__.Portal, null),
  portalZIndex: 99,
  responsive: true,
  role: "img"
};
VictoryContainer.contextType = _victory_util_timer_context__WEBPACK_IMPORTED_MODULE_9__["default"];
...
VictoryTransition.contextType = _victory_util_timer_context__WEBPACK_IMPORTED_MODULE_9__["default"];
