...
/* harmony import */ var victory_vendor_d3_shape__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! victory-vendor/d3-shape */ "../../victory-vendor/es/d3-shape.js");
...
var getSlices = function (props, data) {
  ...
  var layoutFunction = victory_vendor_d3_shape__WEBPACK_IMPORTED_MODULE_4__.pie().sort(null).startAngle(victory_core__WEBPACK_IMPORTED_MODULE_5__.degreesToRadians(props.startAngle)).endAngle(victory_core__WEBPACK_IMPORTED_MODULE_5__.degreesToRadians(props.endAngle)).padAngle(victory_core__WEBPACK_IMPORTED_MODULE_5__.degreesToRadians(padAngle)).value(function (datum) {
    return datum._y;
  });
...
var getCalculatedValues = function (props) {
  ...
  var styleObject = victory_core__WEBPACK_IMPORTED_MODULE_5__.getDefaultStyles(props, "pie");
  var style = victory_core__WEBPACK_IMPORTED_MODULE_5__.getStyles(props.style, styleObject);
  var colors = Array.isArray(colorScale) ? colorScale : victory_core__WEBPACK_IMPORTED_MODULE_6__.getColorScale(colorScale);
  var padding = victory_core__WEBPACK_IMPORTED_MODULE_5__.getPadding(props);
...
var getLabelArc = function (labelRadius) {
  return victory_vendor_d3_shape__WEBPACK_IMPORTED_MODULE_4__.arc().outerRadius(labelRadius).innerRadius(labelRadius);
};
...
var getBaseLabelAngle = function (slice, labelPosition, labelStyle) {
  ...
  if (labelPosition.angle !== undefined) {
    ...
    baseAngle = victory_core__WEBPACK_IMPORTED_MODULE_5__.radiansToDegrees((slice.startAngle + slice.endAngle) / 2);
  } else {
    baseAngle = labelPosition === "startAngle" ? victory_core__WEBPACK_IMPORTED_MODULE_5__.radiansToDegrees(slice.startAngle) : victory_core__WEBPACK_IMPORTED_MODULE_5__.radiansToDegrees(slice.endAngle);
  }
...
var getLabelProps = function (text, dataProps, calculatedValues) {
  ...
  var labelRadius = victory_core__WEBPACK_IMPORTED_MODULE_5__.evaluateProp(calculatedValues.labelRadius, Object.assign({
    text: text
  }, dataProps));
  var labelPosition = victory_core__WEBPACK_IMPORTED_MODULE_5__.evaluateProp(calculatedValues.labelPosition, Object.assign({
    text: text
  }, dataProps)) || "centroid";
  var labelPlacement = victory_core__WEBPACK_IMPORTED_MODULE_5__.evaluateProp(calculatedValues.labelPlacement, Object.assign({
    text: text
  }, dataProps)) || "vertical";
  var labelStyle = Object.assign({
    padding: 0
  }, style.labels);
  var evaluatedStyle = victory_core__WEBPACK_IMPORTED_MODULE_5__.evaluateStyle(labelStyle, Object.assign({
  ...
  return lodash_defaults__WEBPACK_IMPORTED_MODULE_3___default()({}, labelProps, victory_core__WEBPACK_IMPORTED_MODULE_5__.omit(tooltipTheme, ["style"]));
};

var getXOffsetMultiplayerByAngle = function (angle) {
  return Math.cos(angle - victory_core__WEBPACK_IMPORTED_MODULE_5__.degreesToRadians(90));
};
var getYOffsetMultiplayerByAngle = function (angle) {
  return Math.sin(angle - victory_core__WEBPACK_IMPORTED_MODULE_5__.degreesToRadians(90));
};
...
var getLabelIndicatorPropsForLineSegment = function (props, calculatedValues, labelProps) {
  ...
  return lodash_defaults__WEBPACK_IMPORTED_MODULE_3___default()({}, labelIndicatorProps);
};
var getBaseProps = function (initialProps, fallbackProps) {
  var props = victory_core__WEBPACK_IMPORTED_MODULE_5__.modifyProps(initialProps, fallbackProps, "pie");
  ...
  return slices.reduce(function (childProps, slice, index) {
    var datum = lodash_defaults__WEBPACK_IMPORTED_MODULE_3___default()({}, data[index], {
      startAngle: victory_core__WEBPACK_IMPORTED_MODULE_5__.radiansToDegrees(slice.startAngle),
      endAngle: victory_core__WEBPACK_IMPORTED_MODULE_5__.radiansToDegrees(slice.endAngle),
      padAngle: victory_core__WEBPACK_IMPORTED_MODULE_5__.radiansToDegrees(slice.padAngle)
    });
    ...
    if (text !== undefined && text !== null || labels && (events || sharedEvents)) {
      var evaluatedText = victory_core__WEBPACK_IMPORTED_MODULE_5__.evaluateProp(text, dataProps);
...
/* harmony import */ var victory_vendor_d3_shape__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! victory-vendor/d3-shape */ "../../victory-vendor/es/d3-shape.js");
...
var getPath = function (props) {
  ...
  if (lodash_isFunction__WEBPACK_IMPORTED_MODULE_0___default()(props.pathFunction)) {
  ...
  var pathFunction = victory_vendor_d3_shape__WEBPACK_IMPORTED_MODULE_3__.arc().cornerRadius(cornerRadius).outerRadius(radius).innerRadius(innerRadius || 0);
...
var evaluateProps = function (props) {
  ...
  var radius = victory_core__WEBPACK_IMPORTED_MODULE_4__.evaluateProp(props.radius, Object.assign({}, props, {
    style: style
  }));
  var innerRadius = victory_core__WEBPACK_IMPORTED_MODULE_4__.evaluateProp(props.innerRadius, Object.assign({}, props, {
    style: style,
    radius: radius
  }));
...
var defaultProps = {
  pathComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_5__.Path, null),
  role: "presentation",
  shapeRendering: "auto"
};
...
/* harmony import */ var _slice__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./slice */ "./slice.tsx");
  ...
  _createClass(VictoryPieBase, [{
    ...
    value: function renderComponents(props) {
      ...
      if (showIndicator && labelIndicator) {
        var labelIndicatorComponent = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_2__.LineSegment, null);
        ...
        var labelIndicatorComponents = this.dataKeys.map(function (_dataKey, index) {
          ...
          return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().cloneElement(labelIndicatorComponent, labelIndicatorProps);
        });
...
VictoryPieBase.defaultProps = {
  ...
  standalone: true,
  dataComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_slice__WEBPACK_IMPORTED_MODULE_5__.Slice, null),
  labelComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_6__.VictoryLabel, null),
  containerComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_7__.VictoryContainer, null),
...
VictoryPieBase.getData = victory_core__WEBPACK_IMPORTED_MODULE_10__.getData;
VictoryPieBase.expectedComponents = ["dataComponent", "labelComponent", "groupComponent", "containerComponent", "labelIndicatorComponent"];
var VictoryPie = (0,victory_core__WEBPACK_IMPORTED_MODULE_11__.addEvents)(VictoryPieBase);
