  ...
  var parseEvent = function (eventReturn, eventKey) {
    ...
    var getKeys = function (childName) {
      ...
      if (eventReturn.eventKey === "all") {
        return newBaseProps[childName] ? _without(_keys(newBaseProps[childName]), "parent") : _without(_keys(newBaseProps), "parent");
      } else if (eventReturn.eventKey === undefined && eventKey === "parent") {
        return newBaseProps[childName] ? _keys(newBaseProps[childName]) : _keys(newBaseProps);
      }
    ...
    var allChildNames = childNames === "all" ? _without(_keys(newBaseProps), "parent") : childNames;
