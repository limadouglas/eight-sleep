  ...
  var parseEvent = function (eventReturn, eventKey) {
    ...
    var getKeys = function (childName) {
      ...
      if (eventReturn.eventKey === "all") {
        return newBaseProps[childName] ? (0, _without2.default)((0, _keys2.default)(newBaseProps[childName]), "parent") : (0, _without2.default)((0, _keys2.default)(newBaseProps), "parent");
      } else if (eventReturn.eventKey === undefined && eventKey === "parent") {
        return newBaseProps[childName] ? (0, _keys2.default)(newBaseProps[childName]) : (0, _keys2.default)(newBaseProps);
      }
    ...
    var allChildNames = childNames === "all" ? (0, _without2.default)((0, _keys2.default)(newBaseProps), "parent") : childNames;
